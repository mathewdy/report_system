    ...
    <main class="d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 250px; min-height: 100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="sent.php" class="nav-link text-white active" aria-current="page">
                        <i class="bi bi-stickies me-2"></i>
                        Sent
                    </a>
                </li>
            ...
            <div class="card shadow py-3 mx-4" style="border: none; min-height: 35rem;">
                <table class="table table-bordered" id="data">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM sent WHERE from_user ='$email'";
                        ...
                        if (mysqli_num_rows($run) > 0) {
                            ...
                            foreach ($run as $row) {
                                ...
                                $view_link = "view-sent.php?rid=" . $encryption;
                                $edit_link = "edit-sent.php?rid=" . $encryption;
                                $delete_link = "delete-sent.php?rid=" . $encryption;
                                $count++;
                        ?>
