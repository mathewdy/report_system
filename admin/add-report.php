    ...
    <div class="container">
      <div class="card shadow p-5" style="border: none;">
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <span class="d-flex form-control">
            <label for="">To:</label>
            <input type="text" id="search_data" class="w-100 brgy" style="border:none; outline:none;" placeholder="" autocomplete="off" class="form-control input-lg" />
          </span>
          <span class="d-flex">
            <label for="">Subject:</label>
            <input type="text" class="w-100" name="subject">
          </span>
  ...
  <script>
    ...
    $(".brgy").autocomplete({
      source: function(request, response) {
        $.ajax({
          url: 'http://localhost/report_system/admin/brgy.php',
          type: 'GET',
          dataType: 'json',
