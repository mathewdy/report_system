                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-4">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link text-dark" href="annualy.php">Annual</a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col-lg-8">
                                                <div class="card shadow py-0 mx-4" style="border: none; border-radius: 0; max-height: 70vh; overflow: hidden; overflow-y:scroll ;">
                                                    ...
                                                    $sql = "SELECT *, EXTRACT(Month FROM date_created) AS month,
                                                                    ...
                                                                    FROM reports 
                                                                    WHERE  status = '1' and to_user = '$email' AND YEAR(date_created) = YEAR(CURDATE())
                                                    ...
                                                    ?>
                                                    <!-- january -->
                                                    <h1 class="text-center text-muted h4">January</h1>
                                                    ...
                                                    <!-- Febuary -->
                                                    <table>
                                                        <h1 class="text-center text-muted h4">February</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- March -->
                                                        <h1 class="text-center text-muted h4">March</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- April -->
                                                        <h1 class="text-center text-muted h4">April</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- May -->
                                                        <h1 class="text-center text-muted h4">May</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- June -->
                                                        <h1 class="text-center text-muted h4">June</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- july -->
                                                        <h1 class="text-center text-muted h4">July</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- August -->
                                                        <h1 class="text-center text-muted h4">August</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- September -->
                                                        <h1 class="text-center text-muted h4">September</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- October -->
                                                        <h1 class="text-center text-muted h4">October</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- November -->
                                                        <h1 class="text-center text-muted h4">November</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
                                                        ...
                                                        <!-- December -->
                                                        <h1 class="text-center text-muted h4">December</h1>
                                                        <table class="table table-bordered mb-5">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th>
