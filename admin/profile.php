...
if(isset($_POST['update'])){
    ...
    if(empty($new_image)){
        $query_update_1 = "UPDATE users SET first_name = '$first_name' , middle_name ='$middle_name', last_name = '$last_name', address = '$address', barangay = '$barangay' , barangay_id = '$barangay_id' WHERE email = '$email'";
        ...
        if(!in_array($file_extension,$allowed_extension)){
            ...
            $query_update_2 = "UPDATE users SET first_name = '$first_name' , middle_name ='$middle_name', last_name = '$last_name', address = '$address', barangay = '$barangay' , barangay_id = '$barangay_id', image =  '$update_filename' WHERE email = '$email'";
